...
const SUBCATEGORIES: ToolSubcategory[] = [
  ...
  },
  {
    ...
    category: 'sanding',
    name_zh: '刻线推刀',
    name_en: 'Panel Scriber',
    what_it_is:
      '一种带钩刃的精密推拉式工具，能在塑料件表面刻出精细凹槽线条。和笔刀切割不同，刻线推刀是"推刮"出沟槽，留下整齐的 V 形或 U 形凹线。',
    why_you_need_it:
      '万代很多模型刻线偏浅或缺失，刻线推刀能让你自行加深或新增刻线，让渗线效果更立体。也是改件党的核心工具——重新规划装甲分割线。',
    when_to_use: '想加深默认刻线、添加新刻线增加细节、改件后重新设计装甲走线时。',
    vs_alternatives:
      'vs 笔刀——笔刀是切割，刻线推刀是推刮，刻线效果更整齐、深度可控；vs 刻线针——刻线针只能划痕，无法形成真凹槽。',
    urgency: 'advanced',
    pitfalls: [
  ...
  },
  {
    ...
    category: 'sanding',
    name_zh: '刻线胶带 / 引导胶带',
    name_en: 'Scribing Guide Tape',
    what_it_is:
      '极细（0.4–1mm）的高粘性胶带，专门用作刻线推刀的"引导轨道"。贴在零件表面，沿胶带边缘推刀，确保刻线笔直不跑偏。',
    why_you_need_it:
      '徒手用刻线推刀几乎必跑偏。胶带本身就是"轨道"——你不需要稳定手腕，只要刀刃贴着胶带边缘走即可。',
    when_to_use: '使用刻线推刀时配套使用，几乎不单独使用。',
    vs_alternatives:
      'vs 田宫遮盖带——遮盖带太宽（6mm 起），且边缘没那么锋利。专用刻线胶带边缘更利、宽度更细。',
    urgency: 'advanced',
    pitfalls: [
  ...
  },
  {
    ...
    category: 'workspace',
    name_zh: '工具收纳盒',
    name_en: 'Tool Organizer',
    what_it_is:
      '专门收纳模型工具的多格盒子或工具架，区别于零件分装盒——这个是装钳子、笔刀、镊子等"工具"本体。',
    why_you_need_it:
      '工具乱堆桌面会被刻线推刀刺到、笔刀划到。专用收纳盒让每件工具有"家"，桌面干净也找件快。',
    when_to_use: '工具数量超过 10 件时强烈建议——前期可省略，但收藏满满一墙工具后必备。',
    vs_alternatives:
      'vs 零件分装盒——分装盒装小零件（板件剪下来后分类），收纳盒装工具本体。两者都需要。',
    urgency: 'advanced',
    pitfalls: [
